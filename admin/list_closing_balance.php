...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          List of All Closing Balance      
          </h1>
          <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"> List of All Closing Balance</li>
          </ol>
        </section>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped"> 
					...
					<?php 
					    ...
					    foreach($object->allClosingBalance() as $con=>$row) {						
    ...
    <script>
      ...
      if(chk)
      {
      var closigDtlsId = $(this).children('img').attr('id');    
      var row=$(this).parent().parent();
        $.ajax({

        url:'all_delete',       

        data:{closigDtlsId:closigDtlsId},
