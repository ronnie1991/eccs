    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
        Detailed List Of M.T Loan (From Date - <?= $formatedfrmDt;?> - To Date - <?=$formatedtoDt;?>)
          </h1>
          <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Detailed List Of M.T Loan </li>
          </ol>
        </section>
            ...
            <div class="box">
                ...
                <div class="box-body" style="overflow-x:auto;">
                  <table id="example1" class="table table-bordered table-striped" >
                    <div class="col-sm-3">
                      <a class="btn" style="padding: 0px 12px;background:#dddddd;color: #080808;" href="exclEccsDtlListMTLon?frmDt=<?=$_GET['frmDt'];?>&toDate=<?=$_GET['toDt'];?>"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-file-excel-o"></i>&nbsp;&nbsp;<b>Excel ?</b></a>

                      &nbsp;&nbsp;<a class="btn" style="padding:  0px 1px;background:#dddddd;color: #080808; " href="printDtldListMTLoan?frmDt=<?=$_GET['frmDt']?>&toDt=<?= $_GET['toDt'];?>" target="_blank"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-print"></i>&nbsp;&nbsp;<b>Print-Out?</b></a>
                    ...
                    <tbody>
                      <?php
                       ...
                       $noDays=cal_days_in_month(CAL_GREGORIAN,$month,$year);
                          ...
                          $totalInterest=0;
                          foreach ($object->findAllEmiLedgerMTLoan($frmDt,$toDt) as $rc=>$dLMTl) { 
                      ...
                      <tr>
                        ...
                        <td><?= date("d-m-Y", strtotime($loanLedgerDetls['loan_date']));?></td>
