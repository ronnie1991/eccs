     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          if(isset($_POST['total_recept_genrt']))
          {
          ...
          echo "
            <script type=\"text/javascript\">           
             window.location='total_receipts?frmDt=$frmDt&toDt=$toDt';
            </script>
           ";  
          }                         
          }
        ...
        ?>
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Select from Date & to date to display Total Receipt</h3>
          ...
          <div class="col-md-4">
				 ...
				 <div class="col-md-4">
                   <div class="box-footer">
                    <button type="submit" name="total_recept_genrt" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->
