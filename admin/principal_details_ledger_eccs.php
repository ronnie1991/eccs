      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         M S E S E C C S. Ltd. (Reg. No- 7 PAS-MED, Date- 08.01.2013)         
          ...
          <ol class="breadcrumb">
             <li>
              <a class="btn" style="padding: 0px 12px;background:#dddddd;color: #080808;" href="principalDtlListMT?frmDt=<?=$_GET['frmDt'];?>&toDate=<?=$_GET['toDt'];?>"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-file-excel-o"></i>&nbsp;&nbsp;<b>Excel ?</b></a>

              &nbsp;&nbsp;<a class="btn" style="padding:  0px 1px;background:#dddddd;color: #080808; " href="printPrinciplDtlsMT?frmDt=<?=$_GET['frmDt']?>&toDt=<?= $_GET['toDt'];?>" target="_blank"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-print"></i>&nbsp;&nbsp;<b>Print-Out?</b></a>
