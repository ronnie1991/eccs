    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
         Eccs Expenditure. <?= date("d-M-Y", strtotime($frmDt));?> To <?= date("d-M-Y", strtotime($toDt));?>        
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="row">
            ...
            <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Expenditure </b></h3>
                  <div class="col-sm-3 pull-right">

					<a class="btn" style="padding: 0px 12px;background:#dddddd;color: #080808;" href="exclTotalExpenditure?frmDt=<?=$_GET['frmDt']?>&toDate=<?= $_GET['toDt'];?>"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-file-excel-o"></i>&nbsp;&nbsp;<b>Excel ?</b></a>

					&nbsp;&nbsp;<a class="btn" style="padding:  0px 1px;background:#dddddd;color: #080808; " href="printCashBookExpanditure?frmDt=<?=$_GET['frmDt']?>&toDt=<?= $_GET['toDt'];?>" target="_blank"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-print"></i>&nbsp;&nbsp;<b>Print-Out?</b></a> 
          ...
          <table class="table table-bordered table-striped">
             ...
             <?php } ?>         			         
                 ...
                 <table class="table table-bordered table-striped">
                  ...
                  if($row['loan_type']=='M.T')
                  {             
                  $cgs10=($cgsTotal+(($cgsTotal*10)/100));
                  }
                  if($row['loan_type']=='S.T')
                  {             
                  $cgs10=$cgsTotal;
                  }
