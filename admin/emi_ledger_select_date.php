        ...
        <section class="content">
          ...
          echo "
            <script type=\"text/javascript\">           
             window.location='emi_ldg_dtls_by_date?frmDt=$frmDt&toDt=$toDt';
            </script>
           ";  
          }                         
          }
        ...
        ?>
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Select from Date & to date to display EMI Ledger</h3>
