  ...
  <body class="hold-transition skin-blue sidebar-mini">
     ...
     ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <!-- SELECT2 EXAMPLE -->
      <?php
          if(isset($_POST['add_member_login']))
    ...
    <div class="box-body">
     ...
     <input type="hidden" name="form_id" value="<?= $_SESSION["formid"]?>" />
              <div class="row">
                <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <select name="member_code" class="form-control select2" style="width: 100%;" required="required">
                      <option value="">Select A Member </option>
                       <?php foreach($object->findAllActiveSocietyMBRegistration() as $row) {
                        ?>
                      <option value="<?= $row['sl_no'];?>"><?= $row['member_name'];?>  (Sl.- <?= $row['sl_no'];?> )</option>  
                      <?php } ?>            
                    </select>
                  </div><!-- /.form-group -->                
                </div><!-- /.col --> 
                ...
                <div class="form-group">
                  ...
                  <input id="lognUsrId" type="text" name="mbr_userid" class="form-control" pattern="[a-zA-Z][a-zA-Z\s]*" minlength="5" maxlength="50" oninvalid="setCustomValidity('Enter Valid User Id (Minimum 5 Characters)')"  onchange="try{setCustomValidity('')}catch(e){}" placeholder="Enter a User Id (minimum 5 charecters)"required>
                </div>                 
              </div><!-- /.col -->                   
      </div><!-- /.row -->
        <div class="row">
        ...
        <input type="text" id="password" name="mbr_confirm_password" pattern=".{6,}" oninvalid="setCustomValidity('Enter Minimum 6 Characters ')"  onchange="try{setCustomValidity('')}catch(e){}" class="form-control" placeholder="Enter a password (minimum 6 charecters)"required>
        </div>                 
        </div><!-- /.col -->     
        <div class="col-md-6">                
        <div class="form-group">
        ...
        <div class="col-sm-6">
        <div class="form-group">         
        <button id="submt" type="submit" name="add_member_login" class="btn btn-primary">Submit</button>
        </div>                 
        </div><!-- /.col -->         
        </div><!-- /.row -->                
        </form>
