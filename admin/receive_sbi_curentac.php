     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           S.B.I (Current Account)  
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">S.B.I</a></li>
            <li><a href="#">Bank Interest Receipts</a></li>
          </ol>
        </section>
			 ...
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />              
				<div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="sbi_recv_dt" required="">                         
                  </div><!-- /.form-group -->                  
                </div>				
				 <div class="col-md-6">
                   <div class="box-footer">
                    <button type="submit" name="recev_sbi" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->
