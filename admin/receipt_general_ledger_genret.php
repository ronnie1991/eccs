    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
         Receipt General Ledger (From Date - <?= $frmDt;?> - To Date - <?=$toDt;?>)
          </h1>
          <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="obycs_vsa">Cash Book</a></li>
            <li class="active">Receipt General Ledger </li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
            <div class="box">
            	<a class="btn" style="padding:  0px 1px;background:#dddddd;color: #080808; margin: 0px 65% -29px; " href="printReceiptGL?frmDt=<?= $_GET['frmDt']?>&toDt=<?= $_GET['toDt']?>" target="_blank"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-print"></i>&nbsp;&nbsp;<b>Print Receipt General Ledger</b></a>
                <div class="box-body" >
