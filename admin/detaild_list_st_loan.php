      ...
      <div class="content-wrapper">
        ...
        Detailed List Of S.T Loan (From Date - <?= $formatedfrmDt;?> - To Date - <?=$formatedtoDt;?>)
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Detailed List Of S.T Loan </li>
          </ol>
        </section>
            ...
            <div class="box">
                <div class="box-body" style="overflow-x:auto;">
                  <table id="example1" class="table table-bordered table-striped" >
                    <div class="col-sm-3">
                      <a class="btn" style="padding: 0px 12px;background:#dddddd;color: #080808;" href="exclEccsDtlListSTLon?frmDt=<?=$_GET['frmDt'];?>&toDate=<?=$_GET['toDt'];?>"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-file-excel-o"></i>&nbsp;&nbsp;<b>Excel ?</b></a>

                      &nbsp;&nbsp;<a class="btn" style="padding:  0px 1px;background:#dddddd;color: #080808; " href="printDtldListSTLoan?frmDt=<?=$_GET['frmDt']?>&toDt=<?= $_GET['toDt'];?>" target="_blank"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-print"></i>&nbsp;&nbsp;<b>Print-Out?</b></a>
