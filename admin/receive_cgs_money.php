     ...
     <?php include_once('left_asid.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          Receipt of C.G.S Money
            
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">C.G.S Money</a></li>
            <li class="active">Entry C.G.S Money</li>
          </ol>
        </section>
			   ...
			   <div class="col-md-3">
				...
				<div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="cgsmn_recv_dt" required="">                         
                  </div><!-- /.form-group -->                  
                </div>				
				 <div class="col-md-6">
                   <div class="box-footer">
                    <button type="submit" name="receiv__cgs_money" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->
    ...
    <script>
      $(function () {
        ...
        var mbrNo = $.trim($('.ldfon').val());  
          $.ajax({
          url:'ajax_loan_acno_for_cgs_money',
          data:{mbrNo:mbrNo},
          type : 'POST' ,
          cache:false,
