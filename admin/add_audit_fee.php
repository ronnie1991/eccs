			 ...
			 <input type="hidden" name="form_id" value="<?= $_SESSION['session_form'];?>" />              
				<div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="audit_fee_recv_dt" required="">                         
                  </div><!-- /.form-group -->                  
                </div>				
				 <div class="col-md-6">
                   <div class="box-footer">
                    <button type="submit" name="audit_fee" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->
