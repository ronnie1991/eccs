          ...
          <div class="row">
            ...
            <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><b> Total Amount of EMI Principal=<?= $object->findTotalAmountEMILedgr();?> INR </b></h3>
				  
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
				           <div class="col-sm-3 pull-right">
                     <a class="btn" style="padding: 0px 12px;background:#dddddd;color: #080808;" href="exclAllEmiLedger"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-file-excel-o"></i>&nbsp;&nbsp;<b>Excel ?</b></a>

                      &nbsp;&nbsp;<a class="btn" style="padding:  0px 1px;background:#dddddd;color: #080808; " href="printAllEmiLdgrList" target="_blank"><i style="font-weight: 400;    font-size: 16px;" class="fa fa-print"></i>&nbsp;&nbsp;<b>Print-Out?</b></a>                     
                   </div>
                    ...
                    <tbody>
					<?php          				
					    foreach($object->allEMILedgr() as $con=>$row) {	
