...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      if(isset($_GET['loanAcNumbr'])&&($_GET['savingAcNo']))
      {
        $loanLedgrDetls=$object->creatEMILedgrDtls(base64_decode($_GET['loanAcNumbr']),base64_decode($_GET['savingAcNo']));
      }
      if(isset($_GET['lnacn'])&&($_GET['csa']))
      {
        $lnacn=base64_decode($_GET['lnacn']);
        $csa=base64_decode($_GET['csa'])
       ?>
            ...
            <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
          <?php                 
              foreach($object->singelEMILedgrAllDtls($lnacn,$csa) as $con=>$row) {  
