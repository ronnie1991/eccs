      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-xs-12">
             ...
             <br> <p style="font-size: 16px;font-weight: 600;">MEDINIPUR SADAR EAST SCHOOL EMPLOYEES CO-OPERATIVE CREDIT SOCIETY LTD</p>
              ...
              <b style="font-size: 18px;" >All Share Money List On <?= date("d-M-Y" );?></b>
               </div>
            <div class="box">
          ...
          $idChk2='';
              ...
              foreach($object->findAllActiveCallMoney() as $con=>$row) {
          ...
          ?>
            ...
            <?php  $idChk2=$row['member_slno']; } ?>
                  ...
                  <h4 class="box-title pull-right"><b> Total Amount of Share Money = <?= $object->findTotalAmountCallMoney();?> INR </b></h4>
                  <br><br><br><br>
