      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <?php
				...
				if(isset($_POST['receiv__call_money']))
				{
				if($_POST['form_id']==$_SESSION['session_form'])
				{
				$_SESSION['session_form']='';
				$msg=$object->receivCallMoney();
				}                					
				}
				else
				{
			   ...
			   <div class="col-md-3">
				...
				<div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="clmn_recv_dt" required="">                         
                  </div><!-- /.form-group -->                  
                </div>				
				 <div class="col-md-6">
                   <div class="box-footer">
                    <button type="submit" name="receiv__call_money" class="btn btn-block btn-primary btn-flat">Submit</button>
                  </div>                 
                </div><!-- /.col -->
				</form>
              </div><!-- /.row -->
