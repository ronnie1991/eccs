  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
     ...
     <?php include_once('left_asid.php');
      ...
      $singelLoanDtls=$object->singelLoanAccountNumber($lnIdDecoded);
     ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Close Loan Account of - " <?= $singelLoanDtls['loan_account_no'];?> "  (Type - <?= $singelLoanDtls['loan_type'];?> )  
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Close Loan Account</a></li>
          </ol>
        </section>
        ...
        <section class="content">
		  ...
		  <?php
				...
				$msg=$object->closeLoanAccountNumber($lnIdDecoded);
				}                					
				}
				else
				{
                  ...
                  <div class="form-group">
                    ...
                    <select  class="form-control select2" name="ls" required style="width: 100%;">
                      <option value="" >Select a Loan Status</option>
                       <option value="0" >Bank Closed</option>
                       <option value="2" >Member Closed</option>                        
                    </select>                           
                  </div><!-- /.form-group -->              
                </div>
							<div class="col-md-3">
