    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">        
          <h1>
         Principal Details "S.T" (From Date - <?= $formatedfrmDt;?> - To Date - <?=$formatedtoDt;?>)
          </h1>
          <ol class="breadcrumb">      
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
             ...
             <br> <p style="font-size: 16px;font-weight: 600;">MEDINIPUR SADAR EAST SCHOOL EMPLOYEES CO-OPERATIVE CREDIT SOCIETY LTD</p>
              ...
              <b style="font-size: 18px;" >Principal Details "S.T" (From Date - <?= $formatedfrmDt;?> - To Date - <?=$formatedtoDt;?>)</b>
               </div>  
            <section class="content">
          <div class="row">
            <div class="col-sm-6">
